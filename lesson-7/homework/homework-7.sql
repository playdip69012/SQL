...
GO
SELECT COUNT(DISTINCT FirstName) as ColumnNumber
FROM Customers
---------------------
---------------------
---------------------
...
SELECT
   custid,
   SUM(CASE WHEN Freight > 50 THEN TotalDue ELSE 0 END) AS Total_Heavy_Orders,
   MIN(TotalDue) AS Least_Purchase
